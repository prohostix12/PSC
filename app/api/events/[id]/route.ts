...
import type { EventSection } from "../../../lib/eventUtils";
...
export async function PATCH(
  ...
  try {
    ...
    // Add/Edit Event modal never includes it, so leave it untouched unless
    ...
    if (Array.isArray(body.sections)) {
      setDoc.sections = (body.sections as EventSection[]).map((s) => ({
